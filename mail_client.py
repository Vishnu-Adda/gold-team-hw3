...
username = # put in the sender's username here
...
password = # put in the sender's password here
...
sender = # put in the sender's username, in '< >' here
...
recipient = # put in the recipient's username, in '< >' here
